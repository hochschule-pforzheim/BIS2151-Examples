...
public class BDEM_BMI_Calculator
{
    ...
    public static String checkPerson(String theName)
    {
        ...
        while (theName.length() < 2)
        {  // less than 2 letters are not okay!
    ...
    public static int checkWeight(int theWeight)
    {
        ...
        while (theWeight < 30 || theWeight > 300)
        {  // less than 30 or over 300?--> Bad!
    ...
    public static double checkSize(double theSize)
    {
        ...
        while (theSize < 1.30 || theSize > 2.50)
        {  // size lower 1.30 or over 2.50?--> Bad!
