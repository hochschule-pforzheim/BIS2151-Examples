...
public class DotComVersenken
{
    ...
    private void spielEinrichten()
    {
        ...
        System.out.println("Versuchen Sie, sie mit so wenig versuchen wie m�glich, zu erledigen.");
    ...
    private void beginneSpiel()
    {
        ...
        beendeSpiel();
    } // Methode beginneSpiel schlie�en
    ...
    private void beendeSpiel()
    {
        ...
        if (anzahlVersuche <= 9)
        {
            System.out.println("Sie haben nur " + anzahlVersuche + " Versuche ben�tigt. Sie erhalten den KinoWelt-Preis!");
        }
        else
        {
